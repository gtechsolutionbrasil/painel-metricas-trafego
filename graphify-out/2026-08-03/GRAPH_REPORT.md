# Graph Report - painel-metricas-trafego  (2026-07-20)

## Corpus Check
- 74 files · ~54,166 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 439 nodes · 843 edges · 34 communities (13 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `45bb1e75`
...
- `OverviewPage()` --calls--> `resolveClient()`  [EXTRACTED]
  src/app/(dash)/page.tsx → src/lib/metrics/queries.ts
...
Cohesion: 0.07
Nodes (46): CampaignFilter(), AdDayPoint, AdGroupRow, byConversionActionGrouped(), CampaignRow, ClickTypeRow, ConversionActionGroup, ConversionActionRow (+38 more)

### Community 1 - "Login, Layout & ESLint"
Cohesion: 0.07
Nodes (49): OverviewPage(), platformDetail(), SP, cap(), friendlyOrigin(), SitePage(), SP, BarsChart() (+41 more)

### Community 2 - "Topbar & Camada de dados"
Cohesion: 0.14
Nodes (23): refreshData(), WEBHOOKS, buildMonth(), fmtBR(), iso(), MONTHS, parse(), PeriodPicker() (+15 more)
...
Cohesion: 0.09
Nodes (37): SP, SP, ChannelPage(), ACTION_NAME_LABEL, actionNameLabel(), CATEGORY_LABEL, categoryLabel(), CLICK_TYPE_LABEL (+29 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (45): LoginForm(), safeNextPath(), AccountInput, buildAccounts(), clientSchema, createClientWithAccounts(), deleteClient(), FIELD_LABELS (+37 more)
...
- **Why does `getClients()` connect `Community 29` to `Dependências (package.json)`, `Login, Layout & ESLint`, `Community 28`?**
