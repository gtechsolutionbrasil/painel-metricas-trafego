...
## Corpus Check
- 73 files · ~53,061 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 403 nodes · 760 edges · 32 communities (13 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7764c930`
...
Cohesion: 0.07
Nodes (46): CampaignFilter(), AdDayPoint, AdGroupRow, CampaignRow, ClickTypeRow, ConversionActionGroup, ConversionActionRow, GeoRow (+38 more)
...
Cohesion: 0.10
Nodes (16): LoginForm(), safeNextPath(), refreshData(), WEBHOOKS, DashLayout(), GoogleAdsIcon(), IconProps, MetaAdsIcon() (+8 more)
...
Cohesion: 0.10
Nodes (27): SP, ACTION_NAME_LABEL, CATEGORY_LABEL, categoryLabel(), CLICK_TYPE_LABEL, clickTypeLabel(), GoogleInsights(), MATCH_LABEL (+19 more)
...
- **Why does `getClients()` connect `Login, Layout & ESLint` to `Dependências (package.json)`, `Community 5`, `Community 28`, `Community 29`?**
