...
## Corpus Check
- 68 files · ~45,338 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 395 nodes · 750 edges · 32 communities (13 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48443dc3`
...
Cohesion: 0.08
Nodes (57): ClientesPage(), SP, OverviewPage(), platformDetail(), SP, cap(), friendlyOrigin(), SitePage() (+49 more)
...
Cohesion: 0.06
Nodes (44): SP, ACTION_NAME_LABEL, CATEGORY_LABEL, categoryLabel(), CLICK_TYPE_LABEL, clickTypeLabel(), GoogleInsights(), MATCH_LABEL (+36 more)
